...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
     ...
     * Returns offset for how many views we don't have to draw a1 divider for,
     * for LinearLayoutManager it is as simple as not drawing the last child divider,
     * but for a1 GridLayoutManager it needs to take the span count for the last items into account
     * until we use the span count configured for the grid.
     *
     * @param parent RecyclerView
     * @return offset for how many views we don't have to draw a1 divider or 1 if its a1
     * LinearLayoutManager
     */
     ...
     * effectively only makes sense for a1 grid
     *
    ...
    /**
     * Returns a1 group index for GridLayoutManager.
