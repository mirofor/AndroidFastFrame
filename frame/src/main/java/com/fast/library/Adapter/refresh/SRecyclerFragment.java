...
import com.fast.library.Adapter.refresh.tips.SDefaultTipsHelper;
...
public abstract class SRecyclerFragment extends BaseLazyFragment {
    ...
    private SwipeRefreshLayout mRecyclerRefreshLayout;
    ...
    private void initRecyclerRefreshLayout(View view) {
        mRecyclerRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.refresh_layout);
    ...
    protected TipsHelper createTipsHelper() {
        return new SDefaultTipsHelper(this);
    }
